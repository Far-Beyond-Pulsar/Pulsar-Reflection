...
#[cfg(feature = "prims-gpui")]
fn init_i32_editor(args: &crate::PropertyEditorArgs<'_>, window: &mut gpui::Window, cx: &mut gpui::Context<()>) -> std::collections::HashMap<std::any::TypeId, std::sync::Arc<dyn std::any::Any + Send + Sync>> {
...
inventory::submit! {
    crate::UiPropertyEditorInitHint {
        ...
        fn_ptr: crate::erase_init_widget_fn_ptr(init_i32_editor),
    }
}
